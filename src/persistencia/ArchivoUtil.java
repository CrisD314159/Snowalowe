...
//		Empresa empresa = null;
    ...
    public static void guardarRed(String rutaArchivoVendedores, Red red) {
		try {
			FileOutputStream archivoSalida = new FileOutputStream(rutaArchivoVendedores);
			ObjectOutputStream objetoSalida = new ObjectOutputStream(archivoSalida);
			objetoSalida.writeObject(red);
			objetoSalida.close();
			archivoSalida.close();
	...
	public static Red cargarRed(String ruta) {
		Red red= null;
		try {
			FileInputStream archivoEntrada = new FileInputStream(ruta);
			ObjectInputStream objetoEntrada = new ObjectInputStream(archivoEntrada);
			red = (Red) objetoEntrada.readObject();
			objetoEntrada.close();
			archivoEntrada.close();
			System.out.println("El objeto red ha sido recuperado del archivo.");
